...
public class form_entry_peminjaman extends javax.swing.JDialog {
    ...
    private void btn_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deleteActionPerformed
        ...
        String no_nim = tabmode.getValueAt(baris, 0).toString();
        int ok=JOptionPane.showConfirmDialog(null,"Apakah Anda yakin ingin menghapus data Mahasiswa \n BP :"+no_nim+"?","Konfirmasi",JOptionPane.YES_NO_OPTION);
        if(ok==0){
            try{
                //panggil method koneksi
                Connection con = new koneksi_2().getConnection();
                String sql="delete from tb_peminjaman where no_nim ='"+no_nim+"'";
    ...
    public void tampil_tb_peminjaman(){
        ...
        try {
            ...
            while (hasil.next()){
                String no_nim = hasil.getString("no_nim");
                ...
                String[] data = {no_nim, nama, jurusan, kode_buku, judul_buku, tanggal_terbit, tanggal_pinjam};
                tabmode.addRow(data);
            }
        } catch (Exception e) {
